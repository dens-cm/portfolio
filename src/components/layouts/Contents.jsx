        ...
        <Chakra.Box p='1vw 0vw' display='flex' flexDirection='column'>
            ...
            <Chakra.Box mt='3.5vw' p='1.5vw 0' bg='white' display='flex' flexDirection='column' alignItems='center'>
                <Chakra.Box w='60%' p='1.5vw' display='flex' flexDirection='column' alignItems='flex-start'>
                    ...
                    <Chakra.Text mt='1vw' fontWeight='500' fontStyle='italic'>Skills, tools, and technologies I excel at:</Chakra.Text>
                    <Chakra.Box w='100%' mt='.8vw' display='flex' alignItems='center' justifyContent='space-between'>
                        <Chakra.Box p='1vw .7vw .5vw .7vw' display='flex' flexDirection='column' alignItems='center' cursor='pointer' _hover={{bg: 'red', transition: '.5s'}} transition='.3s' borderRadius='1vw'>
                            <Chakra.Image src={javascript_icon} alt='JavaScirt Icon' w='3.5vw'/>
                            <Chakra.Text mt='.5vw' fontWeight='500'>JavaScript</Chakra.Text>
                        </Chakra.Box>
                        <Chakra.Box p='1vw .7vw .5vw .7vw' display='flex' flexDirection='column' alignItems='center' cursor='pointer' _hover={{bg: 'red', transition: '.5s'}} transition='.3s' borderRadius='1vw'>
                            <Chakra.Image src={reactjs_icon} alt='JavaScirt Icon' w='3.7vw'/>
                            <Chakra.Text mt='.5vw' fontWeight='500'>ReactJS</Chakra.Text>
                        </Chakra.Box>
                        <Chakra.Box p='1vw .7vw .5vw .7vw' display='flex' flexDirection='column' alignItems='center' cursor='pointer' _hover={{bg: 'red', transition: '.5s'}} transition='.3s' borderRadius='1vw'>
                            <Chakra.Image src={chakraui_icon} alt='JavaScirt Icon' w='3.7vw'/>
